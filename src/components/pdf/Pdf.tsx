  ...
  <Document>
    <Page size="LETTER" style={styles.page}>
      ...
      <View style={[styles.container, styles.paddingBottom]}>
        ...
        <View style={styles.boxCompany}>
          ...
          <Text style={styles.text}>
            Comercialización de Etiquetas, Artículos de Oficina, Computación y
            Servicios Afines
          </Text>
          <Text style={styles.text}>
            Dirección: Colbún 4386, Puente Alto, Región Metropolitana
          </Text>
          <Text style={styles.text}>Fonos: (02) 3580415 - (09) 63410833</Text>
          <Text style={styles.text}>
      ...
      <View style={[styles.container, styles.boldText]}>
        ...
        <View
          style={[styles.boxInfo, styles.boxInfoPrice, styles.borderRightWidth]}
        >
      ...
      {quotations.map((item, index) => (
        <View key={index} style={styles.container}>
          <View
            style={[styles.boxInfo, styles.boxInfoItem, styles.borderTopWidth]}
          >
            <Text>{index + 1}</Text>
          </View>
          <View
          ...
          >
            <Text>
              {String(FormattedThousands({ num: item.qty.toString() }) || '')}
            </Text>
          </View>
          <View
            style={[
          ...
          >
            <Text>
              $
              {String(FormattedThousands({ num: item.total.toString() }) || '')}
            </Text>
          </View>
          <View
            style={[
      ...
      <View style={[styles.container, styles.paddingTop_5]}>
        <View style={[styles.boxInfoPriceTotal, styles.borderTopWidth]}></View>
        <View style={[styles.boxInfo, styles.boxInfoPrice, styles.boldText]}>
          <Text>Sub-Total</Text>
        </View>
        <View
          style={[
        ...
        >
          <Text>
            $ {String(FormattedThousands({ num: subTotal.toString() }) || '')}
          </Text>
        </View>
