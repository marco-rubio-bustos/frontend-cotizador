export const messages = {
  error: {
    customer: {
      message1: '¡Error al crear el cliente.!',
      message2: '¡No se seleccionó ningún cliente.!',
      message3: '¡Error al actualizar el cliente.!',
      message4: '¡Error al buscar clientes.!',
      message5: '¡No hay clientes disponibles.!',
    },
    quotation: {
  ...
  success: {
    message1: '¡Se creo el nuevo cliente.!',
    message2: '¡Se creó la cotización correctamente.!',
    message3: '¡Se actualizo el cliente.!',
  },
  alert: {
    danger: 'danger',
    success: 'success',
